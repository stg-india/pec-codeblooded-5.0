...
const SignUp = ()=>{return (
  ...
  <div class="container-forms-ok">
    <div class="container-info-ok">
      <div class="info-item-ok">
        <div class="table-ok">
          <div class="table-cell-ok">
            <p>
              Have an account?
            </p>
            <div class="btn-ok">
    ...
    <div class="container-form-ok">
      <div class="form-item-ok log-in-ok">
        <div class="table-ok">
          <div class="table-cell-ok">
      ...
      <div class="form-item-ok sign-up-ok">
        <div class="table-ok">
          <div class="table-cell-ok">
            <input name="email-ok" placeholder="Email" type="text" /><input name="fullName" placeholder="Full Name" type="text" /><input name="Username" placeholder="Username" type="text" /><input name="Password" placeholder="Password" type="Password" />
            <div class="btn-ok">
              Sign up
            </div>
          </div>
